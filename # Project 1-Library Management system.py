...
def adminsign():
    ...
    if b.split(",")[0][0].isalpha() and len(b.split(",")[0])>=5 and len(b.split(",")[1])>=6 and 1^(b.split(",")[1]).isspace():
        data = open("d:/PProject/Admin.txt").read().split("\n")
        c=0
        for j in range(len(data)-1):
            ...
            if b.split(",")[0] == s[0]:
                ...
                break
        if c==0:
            open("d:/PProject/Admin.txt","a").write(b)
...
def adminlog():
    ...
    if b in open("d:/PProject/Admin.txt").read():
...
def stdsign():
    ...
    if b.split(",")[0][0].isalpha() and b.split(",")[1].isdigit() and len(b.split(",")[1])==10 and len(b.split(",")[2])>=6 and 1^(b.split(",")[2]).isspace():
        c=0
        data = open("d:/PProject/Student.txt").read().split("\n")
        for j in range(len(data)-1):
            s= data[j].split(",")
            if b.split(",")[1] == s[1]:
                ...
                c=1
        if c==0:
            open("d:/PProject/Student.txt","a").write(b)
            print("---You are Successfully Signed In---".center(120))
            if input("Do You Want to Login (Y/N) : ").lower()=="y":
                stdlog()
            else:
...
def stdlog():
    ...
    #if b in open("D:/PProject/Student.txt").read():
            print("---You are Successfully Logged In---".center(120))
            c=1
            stdpage(b)
    if c==0:
...
def addbook():
    ...
    if b.split(",")[0].isdigit() and b.split(",")[3].isdigit() and b.split(",")[3]>'0':
        data = open("d:/PProject/Books.txt").read().split("\n")
        c=0
        for j in range(len(data)-1):
            s= data[j].split(",")
            if b.split(",")[0] == s[0]:
            #if b.split(",")[0] in open("d:/PProject/Books.txt").read():
                print("Cannot Add: 'Books with ISBN No.",(b.split(",")[0]),"is already exist")
                c=1
        if c==0:
                open("d:/PProject/Books.txt","a").write(b)
...
def bookupdate():
    ...
    b="%s"%(input("ISBN NO :   "))
    if b.isdigit():
     if b in open("d:/PProject/Books.txt").read():
        e=input('''
        ...
        if e is '1':
                    ...
                    if b==s[0]:
                      ...
                      if n.isdigit():
                       if s[-1]<=n and n>'0':
                          ...
                          s=open("d:/PProject/Books.txt").read().replace(r,q)
                          open("d:/PProject/Books.txt","w").write(s)
            ...
            for j in range(len(data)-1):
                  ...
                  if b ==s[0]:
                      if s[-1]=='0':
                          r=s[0]+","+s[1]+","+s[2]+","+s[3]+","+s[4]+"\n"
                          s=open("d:/PProject/Books.txt").read().replace(r,"")
                          open("d:/PProject/Books.txt","w").write(s)
...
def userdetail():
    ...
    print("".center(63,"~").center(120))
    data=open("d:/PProject/Student.txt").readlines()
    a=open("d:/PProject/Issuedbook.txt").readlines()
    for j in data:
        c=0
        d=""
        k=j.split(",")
...
def issuebook(b):
    ...
    for j in range(len(data)-1):
        ...
        l=s
        if c==s[0]:
    #if c in open("d:/PProject/Books.txt").read():
            if c+","+b.split(",")[0] in open("D:/PProject/Issuedbook.txt").read():
                ...
                if aval=='0':
                  ...
                  open("D:/PProject/Issuedbook.txt","a").write(iss)
...
def  viewissue(b):
      ...
      print("".center(46,"~").center(120))
      data=open("d:/PProject/Issuedbook.txt").read().split("\n")
      k=0
      for i in range(len(data)-1):
          d=data[i].split(",")
          if b.split(",")[0] ==d[1]:
      ...
      if b.split(",")[0] ==d[1]:
        ...
        if bn==d[0]:
            ...
            if input("Do you Want to return book Y/N : ").lower()=='y':
                e=d[0]+","+d[1]+","+d[2]+","+d[3]+"\n"
                s=open("d:/PProject/Issuedbook.txt").read().replace(e,"")
                open("d:/PProject/Issuedbook.txt","w").write(s)
                dt=open("d:/PProject/Books.txt").read().split("\n")
                for j in range(len(dt)-1):
                  t=dt[j].split(",")
                  if bn==t[0]:
                      e=t[0]+","+t[1]+","+t[2]+","+t[3]+","+t[4]+"\n"
                      f=t[0]+","+t[1]+","+t[2]+","+t[3]+","+str(int(t[4])-1)+"\n"
                      st=open("d:/PProject/Books.txt").read().replace(e,f)
                      open("d:/PProject/Books.txt","w").write(st)
